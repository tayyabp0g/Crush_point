  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#4d83fe]">
      ...
      >
        ...
        <img src={logo} alt="Crushpoint Logo" className="w-120  z-10" style={{ marginTop: "100px" }} />
        </div>
        {/* Right Side */}
          ...
          <form className="relative z-10 w-full max-w-md px-8 py-10 flex flex-col gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="rounded-md px-4 py-2 bg-transparent border border-gray-300 text-white placeholder-white placeholder:text-sm focus:outline-none w-full mt-1"
              />
            </div>
            <div>
              <label className="text-white">Plant Code</label>
              <input
                type="text"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="rounded-md px-4 py-2 bg-transparent border border-gray-300 text-white placeholder-white placeholder:text-sm focus:outline-none w-full mt-1 pr-10"
                />
                <span
            ...
            <a href="/forgot-password" className="text-blue-200 text-center mt-2 hover:underline">
              Forgot Password?
            </a>
          </form>
        </div>
